...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_SHIFT]           = {COMPOUND_STRING("GANTI"),           CursorCb_SendMon},
    [MENU_SEND_OUT]        = {COMPOUND_STRING("KIRIM"),           CursorCb_SendMon},
    [MENU_ENTER]           = {COMPOUND_STRING("MASUK"),           CursorCb_Enter},
    [MENU_NO_ENTRY]        = {COMPOUND_STRING("TIDAK BISA"),      CursorCb_NoEntry},
    [MENU_STORE]           = {COMPOUND_STRING("SIMPAN"),          CursorCb_Store},
